...
public class Bigram {
  ...
  public static class TokenizerMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
      ...
      docId.set(doc[0]);
      String[] words = doc[1].toLowerCase().replaceAll("[^a-z]+", " ").split(" ");
      ...
      for (int i = 0; i < words.length - 1; i++) {
        ...
        if (bigram.equals("computer science") || bigram.equals("information retrieval") || bigram.equals("power politics") || bigram.equals("los angeles") || bigram.equals("bruce willis")) {
          context.write(new Text(bigram), docId);
        }
      }
    }
  }
